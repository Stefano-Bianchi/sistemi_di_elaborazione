...
public class Riconoscimento {
    ...
    public Riconoscimento(JSONObject json){
        ...
        this.id=(long) json.get("id"); // per quanto noi memorizziamo interi come id, lui nel cast lo gestisce come long
        this.isNew=(long) json.get("new");
